...
//----------------------------------------------
pair<vector<string>,bool>  fileBrowserCore (string dirTmpl_toBrowse, string filetype)
{
...
//==========================================
pair<vector<string>,bool>  fileBrowser (TString dirTmpl_toBrowse,  string filetype="root")
{
...
//===========================================
pair<vector<string>,bool>  fileBrowser (string dirTmpl_toBrowse,  string filetype="root")
{
